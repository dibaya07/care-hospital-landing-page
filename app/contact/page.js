...
export default function page() {
  return (
    <div className=" flex flex-col items-center  ">
      <span className="text-xl md:text-2xl lg:text-4xl font-semibold text-[#04155f] mt-8 mb-3 tracking-wider text-center">
        Precision Care starts with a conversation
      </span>
      <span className="w-[80%] md:w-[80%] text-center text-[10px] md:text-sm lg:text-base">
      ...
      <div className=" w-[90%] mt-16 flex flex-wrap gap-20 justify-center mb-24">
        <div className=" flex flex-col w-[98%] md:w-[60%] lg:w-[45%]  xl:w-1/3 py-6 px-6 rounded-2xl shadow-[1px_1px_30px_#87967533]">
          ...
          <form className="my-6 flex flex-col gap-3 text-xs sm:text-base">
