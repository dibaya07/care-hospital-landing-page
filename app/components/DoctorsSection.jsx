...
export default function DoctorsSection() {
  return (
    <div className=' rounded-xl py-4 px-6 flex-1 shadow-[1px_2px_10px_#73849366]'>
      <h2 className='font-semibold text-sm text-[#1eb9bf] mb-1.5'>OUR DOCTORS</h2>
      <h1 className='font-semibold text-xl text-[#051d70]'>Experienced, Qualified</h1>
      <h1 className='font-semibold text-xl text-[#051d70]'>Always by your side </h1>
