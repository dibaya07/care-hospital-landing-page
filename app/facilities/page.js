      ...
      <div className=" w-[90%] mt-16 flex flex-wrap gap-20 justify-center mb-16">
        ...
        <div className=" flex flex-col w-1/3 py-6 px-6 rounded-2xl shadow-[1px_1px_30px_#87967533]">
          <span className=" p-1  rounded-lg w-full flex justify-center mb-4">
            <Image src={"/facility.jpeg"} alt='doctor img' width={100} height={10} className='h-70 w-62.5 rounded-2xl' />
          </span>
          <span className="font-semibold tracking-wide mb-2.5">Surgical Wing</span>
          <span className="text-sm font-light">
            Equipped for complex cardiothoracic, neurosurgical, and orthopedic procedures with real-time digital integration.
          </span>
